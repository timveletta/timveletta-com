...
featuredimage: /img/lambda-direct.jpg
tags:
  - aws
  - amplify
  - lambda
...
![Calling our mutation through the AppSync console.](/img/screen-shot-2020-12-09-at-1.45.33-pm.png "Calling our mutation through the AppSync console.")
...
![Our resulting pipeline resolver.](/img/screen-shot-2020-12-09-at-1.47.57-pm.png "Our resulting pipeline resolver.")
...
![Our pipeline resolver with multiple function calls.](/img/screen-shot-2020-12-09-at-2.00.19-pm.png "Our pipeline resolver with multiple function calls.")
